"""
Django settings for damp_truth_44477 project.
...
ROOT_URLCONF = 'damp_truth_44477.urls'
...
WSGI_APPLICATION = 'damp_truth_44477.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "damp_truth_44477 API",
    "DESCRIPTION": "API documentation for damp_truth_44477 App",
    "VERSION": "v1",
}
